...
public class FileHandling {
	...
	public static void main(String[] args) {
		...
		while (cont.equalsIgnoreCase("y")) {
			System.out.println("\b\b Employee Information System\n\n");
			...
			System.out.println("Can we proceed further? Yes/No");
	...
	public static void DeleteRecordByID() throws IOException {
		...
		System.out.println("\b\b Delete Employee Record\n\n");
	...
	public static void SearchRecordbyID() throws IOException {
		...
		System.out.println("\b\b Search Employee Record\n");
	...
	public static void updateRecordbyID() throws IOException {
		...
		System.out.println("\b\b Update Employee Record\n\n");
		/**/
